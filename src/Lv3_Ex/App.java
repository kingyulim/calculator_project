...
public class App {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String operateString = input.nextLine();
            ConstOperator operateReturn = null;
            try {
                operateReturn = ConstOperator.operateConstReturn(operateString);
            ...
            double sumValue = 0;
            try {
                sumValue = calculator.operatorMethod(firstValue, secondValue, operateReturn);
